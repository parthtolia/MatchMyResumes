...
export default function AtsScoreResult({ total_score, breakdown, matched_keywords, missing_keywords }: AtsScoreResultProps) {
  const details = (breakdown.details || {}) as Record<string, unknown>
  const tips: string[] = []

  // Extract tips from details
  ...
  return (
    ...
    >
      ...
      <div className="text-center pt-4">
        <p className="text-gray-500 text-sm mb-3">Want to save results and track progress over time?</p>
        <Link
          href="/sign-up"
